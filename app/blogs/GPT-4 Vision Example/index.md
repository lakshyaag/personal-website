---
title: 'Use Vision API to detect products and generate advertising copy'
date: '2023-12-20'
description: 'This post demonstrates how to use GPT-4 Vision API automatically generate advertising copy from just product images using the OpenAI API.'
tags:
  - 'CS:GO'
  - 'Data Visualization'
coverImage: './cover.webp'
slug: 'gpt-4-vision-example'
---
...
The `instructor` library makes it simple to query for data in a structured format, opening up a wide range of possibilities for AI-powered applications.

The full code is available on [GitHub](https://www.github.com/lakshyaag/image-to-ad-copy).
...
Finally, we can put it all together in a single function that takes a list of image URLs and generates advertising copy for the products identified in the images. Please refer to the [full code](https://www.github.com/lakshyaag/image-to-ad-copy) for the complete implementation.
