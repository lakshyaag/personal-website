...
<Video src="/blogs/building-a-pokemon-arena/PokeArena_Player_vs_Agent.mp4" />

**Random Player vs Agent** - A baseline comparison where the agent fights a bot that just picks random moves:

<Video src="/blogs/building-a-pokemon-arena/PokeArena_Random_vs_Agent.mp4" />

**Agent vs Agent** - Two LLMs battling each other:

<Video src="/blogs/building-a-pokemon-arena/PokeArena_Agent_vs_Agent.mp4" />
